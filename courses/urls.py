...
urlpatterns=[
    ...
    url(r'^module/order/$', views.module_order, name='module_order'),
    url(r'^content/order/$', views.content_order, name='content_order'),
    ...
    url(r'^(?P<pk>\d+)/(?P<module_id>\d+)/$', views.CourseDetailView.as_view(), name='course_detail1'),
